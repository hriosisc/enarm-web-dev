        ...
        <div className='main-container'>
            <div className="study-wrapper">
                <div className="wrapper-header">
                    <div>
                        <h3 className='medium-20'>Guía de Estudio</h3>
                ...
                <div className="wrapper-body">
                    <div>
                        <div className='guide-title'>
                            ...
                            <span className='regular-14 blue'>Primera parte 1/2</span>
                        </div>
                    ...
                    <div className='guide-parrafs'>
                        <p className='regular-14'>Introducción</p>
                        <br />
                        <p className='regular-14'>Estimuado alumno:</p>
